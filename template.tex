...
\begin{nextsection}{Professional Timeline}[\nextSVGIcon{email}]
    \begin{nexttimeline}
        \nexttimelineevent{\textbf{June 2010} \\ New York, NY}{
        ...
        \nexttimelineevent{\textbf{May 2014} \\ Boston, MA}{
        ...
        \nexttimelineevent{\textbf{August 2015} \\ San Francisco, CA}{
        ...
        \nexttimelineevent{\textbf{December 2018} \\ Remote}{
            \textbf{Senior Software Architect --- InnovateTech Solutions}
            \vspace{0.2em}
            \begin{itemize}[leftmargin=*,topsep=2pt,itemsep=1pt]
                \item Led architecture design for cloud-native applications
                \item Managed team of 8 developers across 3 time zones
                \item Implemented CI/CD pipelines reducing deployment time by 60\%
                \item Introduced microservices architecture
            \end{itemize}
        }
    \end{nexttimeline}
\end{nextsection}
