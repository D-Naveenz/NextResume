...
\begin{nextsection}{Experience}[\nextSVGIcon{email}]
    \begin{nexttimeline}
        \nexttimelineevent{\DateAndLocation{June 2010}{New York, NY}}{
            \ExperienceHeading{Software Engineer}{Tech Solutions Inc.}
        ...
        \nexttimelineevent{\DateAndLocation{May 2014}{Boston, MA}}{
            \ExperienceHeading{Research Assistant}{AI Lab}
            \begin{itemize}[leftmargin=*,topsep=2pt,itemsep=1pt]
...
\begin{nextsection}{Projects}[\nextSVGIcon{email}]
    \begin{nexttimeline}
        \nexttimelineevent{\DateAndLocation{June 2010}}{
            \Heading{Name 1, Customer experience optimizer and sales management system}
            ...
            \end{itemize}
            \smallskip
            \textcolor{emphasis}{\textbf{Technologies: }}ASP.NET, Vue.js, Node.js, MS SQL
        }
    \end{nexttimeline}
\end{nextsection}
